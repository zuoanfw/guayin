...
return array(
    ...
    'icon' => 'logo.jpg',
    'config' => array(
        array('name' => 'alipay_account','label'=>'支付宝帐户'  , 'description' => '' ,  'type' => 'text',   'value' => '' ),
        ...
        array('name' => 'alipay_private_key','label'=>'秘钥' , 'description' => 'APP端所需秘钥,PC端无需配置', 'type' => 'textarea',   'value' => '' ),
